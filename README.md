...
For all features, see the [syntax documentation](doc/syntax.md) for details.

## Scheduling and LoRA loading

Prompt control provides a way to easily schedule different prompts and control LoRA loading. The syntax is similar to the Automatic1111 WebUI.
